...
[centers, radii] = imfindcircles(rgb,rango)
...
[centers, radii] = imfindcircles(rgb,rango,'ObjectPolarity','dark', ...
    'Sensitivity',1)
...
[centers, radii] = imfindcircles(rgb,rango,'ObjectPolarity','bright', ...
    'Sensitivity',1);
...
[centersBright, radiiBright, metricBright] = imfindcircles(rgb,rango, ...
